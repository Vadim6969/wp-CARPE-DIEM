...
<section class="hero">
	<div class="hero__bg" aria-hidden="true">
		<svg class="hero__bolt hero__bolt--left" viewBox="0 0 100 400" fill="none" preserveAspectRatio="none">
		...
		<svg class="hero__bolt hero__bolt--right" viewBox="0 0 100 400" fill="none" preserveAspectRatio="none">
